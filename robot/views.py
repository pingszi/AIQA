...
def search(request):
    ...
    @return HttpResponse
    """
    rst = {'uuid_key': '', 'msg': '意外错误', 'status': 0,'ai_answer': [],'ai_relative_answer':[],'ai_policy_answer':[], 'no_result':0, 'no_relative_result':0, 'no_policy_result':0, 'all_no_answer':'抱歉，您的提问对小穗来说，超纲啦！请在工作时间咨询老师。如有需要，请联系 QQ：275598139。', 'question':''}
